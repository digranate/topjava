...
public class MealsUtil {
    ...
    public static Map<Integer, Meal> mealsMap = new ConcurrentHashMap<>();
    ...
    static
    {
        ...
        mealsMap.put(1,new Meal(1, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500) );
        mealsMap.put(2,new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000));
        mealsMap.put(3, new Meal(3, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500));
        mealsMap.put(4,new Meal(4, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000));
        mealsMap.put(5,new Meal(5, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500));
        mealsMap.put(6,new Meal(6, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510));
    ...
    public static List<MealWithExceed> getWithExceeded(Map<Integer, Meal> meals, int caloriesPerDay) {
        return getFilteredWithExceeded(meals, LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }


    public static List<MealWithExceed> getFilteredWithExceeded(Map<Integer, Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
